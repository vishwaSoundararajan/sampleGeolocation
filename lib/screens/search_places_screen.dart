...
const kGoogleApiKey = "AIzaSyAf0TobOpwQHhqM5zs_JduUkizxRbZhVsI";
...
class _SearchPlacesScreenState extends State<SearchPlacesScreen> {
  ...
  Future<void> _handlePressButton() async {
    Prediction? p = await PlacesAutocomplete.show(
        context: context,
        apiKey: "AIzaSyAf0TobOpwQHhqM5zs_JduUkizxRbZhVsI",
        onError: onError,
        mode: _mode,
        language: 'en',
        strictbounds: false,
        ...
        components: [Component(Component.country,"pk"),Component(Component.country,"ind")]);
